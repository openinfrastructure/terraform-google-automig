...
variable "name_prefix" {
  description = "The name prefix to us for managed resources, for example 'proxy'.  Intended for major version upgrades of the module.  Use a unique value for each region.  See also UPGRADE.md for major version upgrades."
  type        = string
  default     = "net"
}
...
variable "nic0_subnet" {
  description = "The name of the subnet the nic0 interface attaches to.  Do not specify as a fully qualified name."
  type        = string
}
...
variable "machine_type" {
  description = "The machine type of each instance.  Check the table for Maximum egress bandwidth - https://cloud.google.com/compute/docs/machine-types"
  type        = string
...
variable "disk_size_gb" {
  description = "The size in GB of the persistent disk attached to each instance."
  type        = string
  default     = "100"
}
